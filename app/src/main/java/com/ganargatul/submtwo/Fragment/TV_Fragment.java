 ...
 */
public class TV_Fragment extends Fragment implements MovieTvAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = v.findViewById(R.id.tv_recycler);
    ...
    private void Show() {
        ...
        mMovieTvAdapter.setOnItemClickListener(TV_Fragment.this);
    ...
    private void Prepare() {
        ...
        photo = getResources().obtainTypedArray(R.array.tv_photo);
    }
